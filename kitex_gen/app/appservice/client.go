...
type Client interface {
	...
	GetFileKey(ctx context.Context, req *app.GetFileRequest, callOptions ...callopt.Option) (r *app.GetFileKeyResponse, err error)
...
func (p *kAppServiceClient) GetFileKey(ctx context.Context, req *app.GetFileRequest, callOptions ...callopt.Option) (r *app.GetFileKeyResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
